...
#ifdef ARCH_ARMV4L
//extern void arm_memcpy( void* dst, void* src, int size );
//extern void arm_memset( void* dst, unsigned char val, int size );
//#define memset(a,b,c) arm_memset(a,b,c)
//#define memcpy(a,b,c) arm_memcpy(a,b,c)
#endif
...
#if defined(__GCC__) || defined (WINSCW)
#define AV_NOPTS_VALUE          INT64_C(0x8000000000000000)
#else
#define AV_NOPTS_VALUE          0xFFFFFFFFL
#endif
