...
#define W13 (22725 | (19266 << 16))
#define W26 (21407 | (8867 << 16))
#define W57 (12873 | (4520 << 16))

#define W22 ((-21407 & 0xFFFF) | (21407 << 16))
#define W44 ((-16383 & 0xFFFF) | (16383 << 16))
#define W66 ((-8867 & 0xFFFF) | (8867 << 16))

#define M51 ((-12873 & 0xFFFF) | ((-22725 & 0xFFFF) << 16))
...
w2266idct_rows_armv5te:
        .long ((-21407 & 0xFFFF) | (21407 << 16))
        .long ((-8867 & 0xFFFF) | (8867 << 16))
...
simple_idct_croptbl_armv5te:
        .long (ff_cropTbl + 1024)
m51:    .long ((-12873 & 0xFFFF) | ((-22725 & 0xFFFF) << 16))
w44:    .long ((-16383 & 0xFFFF) | (16383 << 16))
xxx:    .long (((1<<(20-1))/16383)*16383)
m7:     .long (-4520)
...
1:
        ...
        add    a1, a2, v2
        sub    v2, a2, v2
        ldrb   a1, [lr, a1, asr #20]
        ldrb   ip, [lr, ip, asr #20]
        ldrb   v2, [lr, v2, asr #20]
        ldrb   v1, [lr, v1, asr #20]
        orr    ip, ip, a1, asl #8
        ldrd   a1, [sp], #8
        orr    v1, v1, v2, asl #8
        strh   ip, [a3], a4
        ...
        ldrb   a1, [lr, a1, asr #20]
        ldrb   ip, [lr, ip, asr #20]
        ldrb   v4, [lr, v4, asr #20]
        ldrb   v3, [lr, v3, asr #20]
        orr    ip, ip, a1, asl #8
        ldrd   a1, [sp], #8
        orr    v3, v3, v4, asl #8
        strh   ip, [a3], a4
        ...
        ldrb   a1, [lr, a1, asr #20]
        ldrb   ip, [lr, ip, asr #20]
        ldrb   v6, [lr, v6, asr #20]
        ldrb   v5, [lr, v5, asr #20]
        orr    ip, ip, a1, asl #8
        ldrd   a1, [sp], #8
        orr    v5, v5, v6, asl #8
        strh   ip, [a3], a4
        ...
        ldrb   a1, [lr, a1, asr #20]
        ldrb   ip, [lr, ip, asr #20]
        ldrb   v8, [lr, v8, asr #20]
        ldrb   v7, [lr, v7, asr #20]
        orr    ip, ip, a1, asl #8
        strh   ip, [a3], a4
